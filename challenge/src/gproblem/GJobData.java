...
public class GJobData {
	...
	public static GJobData generateRandom(Random rand) {
		double size_ = rand.nextDouble() * (GSupplyLinkProblem.MAX_INSTANCE_JOB_SIZE-GSupplyLinkProblem.MIN_INSTANCE_JOB_SIZE) + GSupplyLinkProblem.MIN_INSTANCE_JOB_SIZE ;
		double dueDate_ = rand.nextDouble() * (GSupplyLinkProblem.MAX_INSTANCE_DUE_DATE-GSupplyLinkProblem.MIN_INSTANCE_DUE_DATE) + GSupplyLinkProblem.MIN_INSTANCE_DUE_DATE ;
		double holdingCost_ = rand.nextDouble() * (GSupplyLinkProblem.MAX_INSTANCE_HOLDING_COST-GSupplyLinkProblem.MIN_INSTANCE_HOLDING_COST) + GSupplyLinkProblem.MIN_INSTANCE_HOLDING_COST ;

		return new GJobData(size_, dueDate_, holdingCost_) ;
	}
